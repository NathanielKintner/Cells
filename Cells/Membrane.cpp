...
//{
//	Organelle::Sense();
//	Brain.SetNNInputForChar(metaData4, innerSolution.size()-5);
//}
//
...
//	}
//	//think
//	if (Brain.GetNNOutputForChar(metaData2) < 10)
//	{
//		return;
//	}
//	Sector& s = Universe::getSectorAtLocation(xpos, ypos);
...
//					{
//						energy += structure.internalEnergy;
//						structure.internalEnergy = 0;
//					}
//					//this stuff was commented before the return. Idk what it does, something with chemistry. Prolly inner reactions.
//					/*
//					int xenv, yenv;
...
//}
//
//void Membrane::init(Compound struc, int crit)
//{
//	Organelle::init(struc, crit);
...
//{
//	//I don't understand this right now, I will find out later why it matters im sure lol
